/* vp_related.js — 「情绪·择时·波动」四研究页互链(共享·DRY)。
   给定当前页 key,渲染指向同簇其余三页的小导航。语言按加载时 vpLang() 取(与 AI 盒一致·渲一次)。
...
(function (win) {
  ...
  function vpRelated(currentKey, elId) {
    ...
    var label = lang === "en" ? "Related · sentiment · timing · volatility" : "相关研究 · 情绪 · 择时 · 波动";
